...
<body>
    ...
    <div class="container_center">
      <div class="container_center--menu">
        <div class="container_center--search">
          <input placeholder="Código del trámite" type="number" id="cedulaBuscador">
          <button id="buscar">
        ...
        <button id="include" class="crear">Registrar Trámite</button>
      </div>
  ...
  <div id="modal" class="modal">
    ...
    <?php require_once("vista/formularios/tramites.formulario.php"); ?>
  </div>
  ...
  <script type="text/javascript" src="js/validations/tramites.js" defer></script>
