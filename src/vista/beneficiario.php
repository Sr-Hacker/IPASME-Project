...
<body>
    ...
    <div class="container_center">
      <div class="container_center--menu">
        <div class="container_center--search">
          <input class="buscador" placeholder="Cédula del beneficiario" type="number" id="cedulaBuscador">
          <button id="buscar">
      ...
      <div class="container_center--list">
        <div id="consultar_beneficiarios"></div>
      </div>
    </div>
  </div>
  ...
  <script type="text/javascript" src="js/validations/beneficiario.js" defer></script>
