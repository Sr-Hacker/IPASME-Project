...
<body>
    ...
    <div class="container_center">
      <div class="container_center--menu">
        <div class="container_center--search">
          <input placeholder="Nombre del requisito" type="number" id="cedulaBuscador">
  ...
  <div id="modal" class="modal">
    ...
    <?php require_once("vista/formularios/requisitos.formulario.php"); ?>
  </div>
  ...
  <script type="text/javascript" src="js/actions/requisitos.js" defer></script>
