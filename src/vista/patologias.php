...
<body>
  <div>
    <center>
      <h2>GESTIÓN DE PATOLOGÍAS</h2>
    </center>
    <div class="container_center">
      <div class="container_center--menu">
        <div class="container_center--search">
          <input class="buscador" placeholder="Nombre de la patología" type="number" id="cedulaBuscador">
        ...
        <button id="include" class="crear">Registrar Patología</button>
      </div>
