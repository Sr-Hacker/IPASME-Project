...
<div class="container_empleados">
  <form action="" class="formulario" id="formulari">

    <div class="formulario__grupo">
      <label for="parentesco" class="formulario__label">Cedula medico</label>
      <input type="text" placeholder="cedula" id="ced_medico" name="ced_medico">
    </div>

    <div class="formulario__grupo" id="grupo__nombres">
    <label for="parentesco" class="formulario__label">Nombre</label>
    <input type="text" placeholder="nombres" id="nombres" name="nombres">
    </div>

    <div class="formulario__grupo" id="grupo__nombres">
    <label for="parentesco" class="formulario__label">Apellido</label>
    <input type="text" placeholder="apellidos" id="apellidos" name="apellidos">
    </div>


    <div class="formulario__grupo" id="grupo__nombres">
    <label for="parentesco" class="formulario__label">Telefono</label>
    <input type="text" placeholder="telefono" id="telefono" name="telefono">
    </div>


    <div class="formulario__grupo" id="grupo__nombres">
    <label for="parentesco" class="formulario__label">Estado</label>
      ...
      <div class="formulario__grupo" id="grupo__nombres">
        <label for="parentesco" class="formulario__label">Especialidad</label>
