...
<!-- <div class="container">
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<label class="navbar-brand" >Menu principal</label>
		 ...
		 <ul class="navbar-nav">
			  <li class="nav-item dropdown">
				  ...
				  <div class="dropdown-menu">
					<a class="dropdown-item" href="?pagina=personasaj">Personas con AJAX</a>
					<a class="dropdown-item" href="?pagina=personasaj2">Personas con AJAX 2</a>
				  </div>
			  </li>
		 </ul>
		</div>
