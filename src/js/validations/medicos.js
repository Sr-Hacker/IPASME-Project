...
const validarFormulario = (e) => {
	switch (e.target.name) {
		case "ced_medico":
			validarCampo(expresiones.cedula, e.target, 'ced_medico');
		break;
		case "nombre":
			validarCampo(expresiones.dos_nombres, e.target, 'nombre');
		break;
		case "apellido":
			validarCampo(expresiones.dos_nombres, e.target, 'apellido');
		break;
		case "telefono":
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.ced_medico && campos.nombre && campos.apellido && campos.telefono){
