...
const validarFormulario = (e) => {
	switch (e.target.name) {
		...
		break;
		case "descripcion":
			validarCampo(expresiones.direccion, e.target, 'descripcion');
		break;
		case "diagnostico":
			validarCampo(expresiones.direccion, e.target, 'diagnostico');
		break;
	}
}
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.cod_informe && campos.n_consulta && campos.descripcion && campos.diagnostico ){ 
