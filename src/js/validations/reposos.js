...
const validarFormulario = (e) => {
	switch (e.target.name) {
		case "n_reposo":
			validarCampo(expresiones.codigo, e.target, 'n_reposo');
		break;
		case "n_consulta":
			validarCampo(expresiones.codigo, e.target, 'n_consulta');
		break;
		case "motivo":
		...
		break;
		case "fecha_inicio":
			validarCampo(expresiones.fecha, e.target, 'fecha_inicio');
		break;
		case "fecha_final":
			validarCampo(expresiones.fecha, e.target, 'fecha_final');
		break;
	}
}
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.n_reposo && campos.n_consulta && campos.motivo && campos.instrucciones && campos.fecha_inicio && campos.fecha_final){ 	
