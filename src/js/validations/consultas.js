...
const validarFormulario = (e) => {
	switch (e.target.name) {
		...
		break;
		case "cod_cita":
			validarCampo(expresiones.codigo, e.target, 'cod_cita');
		break;
		case "n_historia":
		...
		break;
		case "detalle":
			validarCampo(expresiones.direccion, e.target, 'detalle');
		break;
	}
}
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.n_consulta && campos.cod_cita && campos.n_historia && campos.motivo && campos.detalle){
