...
const validarFormulario = (e) => {
	switch (e.target.name) {
		case "n_historia":
			validarCampo(expresiones.codigo, e.target, 'n_historia');
		break;
		case "fecha_registro":
			validarCampo(expresiones.fecha, e.target, 'fecha_registro');
		break;
		case "partida_nacimiento":
			validarCampo(expresiones.direccion, e.target, 'partida_nacimiento');
		break;
		case "acta_matrimonio":
			validarCampo(expresiones.direccion, e.target, 'acta_matrimonio');
		break;
		case "constancia_trabajo":
			validarCampo(expresiones.direccion, e.target, 'constancia_trabajo');
		break;
	}
}
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.n_historia && campos.fecha_registro && campos.partida_nacimiento && campos.acta_matrimonio && campos.constancia_trabajo){ 	
