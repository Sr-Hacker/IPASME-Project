...
const validarFormulario = (e) => {
	switch (e.target.name) {
		case "n_solicitud":
			validarCampo(expresiones.codigo, e.target, 'n_solicitud');
		break;
		case "ced_afiliado":
			validarCampo(expresiones.codigo, e.target, 'ced_afiliado');
		break;
		case "cod_tramite":
			validarCampo(expresiones.codigo, e.target, 'cod_tramite');
		break;
		case "fecha_emision":
			validarCampo(expresiones.fecha, e.target, 'fecha_emision');
		break;
		case "fecha_final":
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.n_solicitud && campos.ced_afiliado && campos.cod_tramite && campos.fecha_emision && campos.fecha_final){
