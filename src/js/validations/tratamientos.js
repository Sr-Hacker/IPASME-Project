...
const validarFormulario = (e) => {
	switch (e.target.name) {
		case "n_tratamiento":
			validarCampo(expresiones.codigo, e.target, 'n_tratamiento');
		break;
		case "cod_informe":
			validarCampo(expresiones.codigo, e.target, 'cod_informe');
		break;
		case "instrucciones":
			validarCampo(expresiones.direccion, e.target, 'instrucciones');
		break;
		case "motivo":
			validarCampo(expresiones.direccion, e.target, 'motivo');
		break;
		case "tiempo_tratamiento":
			validarCampo(expresiones.direccion, e.target, 'tiempo_tratamiento');
		break;
	}
}
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.n_tratamiento && campos.cod_informe && campos.instrucciones && campos.motivo && campos.tiempo_tratamiento){
